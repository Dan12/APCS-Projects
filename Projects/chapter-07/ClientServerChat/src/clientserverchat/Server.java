...
public class Server{
    ...
    public void runServer() {
        ...
        try {
            listener = new ServerSocket(ClientServerChat.PORT);
    ...
    private class Sender extends Thread{
        ...
        public void run(){
            while(true){
                //System.out.println("Sender:"+names.size()+","+squaresRecieved);
                try {
                    Thread.sleep(0, 500);
...
//                    System.out.println(input);
//                    System.out.println("Squares:"+squaresRecieved);
                    if(input.startsWith("SQUARE")){
                        if(!dataOutLine.contains(name)){
                            dataOutLine+=input.substring(7)+"~n`";
//                            System.out.println(input.substring(7)+","+squaresRecieved+"*   *"+squareLine);
                            playerDataRecieved++;                    
                        }
                    }
                    else{
                        ...
                        messageArea.setText(ClientServerChat.decodeLine(textLog));
                    }
                }
            } catch (IOException e) {System.out.println(e);} 
            finally {
