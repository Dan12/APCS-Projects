...
//                System.out.println(allLines);
                ...
                if (allLines.startsWith("SUBMITNAME")) {
                    ...
                    drawPanel.st.changeName(drawPanel.clientName);
                    ...
                    if(!drawPanel.drawingSharedObject){
                        ...
                        for(int i = 0; i < squareInfos.length; i++){
                            ...
                            drawPanel.stickfigures.add(new StickFigure(parameters, drawPanel.map.offsetX, drawPanel.map.offsetY));
                        }
