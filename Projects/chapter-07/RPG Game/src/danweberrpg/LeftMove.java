...
public class LeftMove{  
    ...
    public void runAnimation(){
        if(stx.fromRest){
            ...
            stx.goToAngle(2, stx.restLA, -stx.sdArmAngle, 1, 21, stx.walkAnimStep, false);
            stx.goToAngle(3, -stx.restUA, stx.sdArmAngle, 1, 21, stx.walkAnimStep, false);
            stx.goToAngle(4, -stx.restLA, stx.sdArmAngle+stx.sdLowerArmIncrease, 1, 21, stx.walkAnimStep, false);
            
            stx.goToAngle(5, stx.restUA, -stx.sdLegExtendAngle, 1, 21, stx.walkAnimStep, false);
            stx.goToAngle(6, stx.restLA, -stx.sdLegExtendAngle, 1, 21, stx.walkAnimStep, false);
            stx.goToAngle(7, -stx.restUA, stx.sdLegExtendAngle, 1, 21, stx.walkAnimStep, false);
            stx.goToAngle(8, -stx.restLA, stx.sdLegExtendAngle, 11, 21, stx.walkAnimStep, false);
            ...
            if(!stx.toRest){
                ...
                stx.goToAngle(2, -stx.sdArmAngle, stx.restLA, 1, 11, stx.walkAnimStep, false);
                stx.goToAngle(3, stx.sdArmAngle, -stx.restUA, 1, 11, stx.walkAnimStep, false);
                stx.goToAngle(4, stx.sdArmAngle+stx.sdLowerArmIncrease, -stx.restLA, 1, 11, stx.walkAnimStep, false);
