...
public class Lab1001 extends JPanel implements ActionListener, ChangeListener
{
  //<editor-fold defaultstate="collapsed" desc="--Instance variables declarations--">
  private JMenuBar menuBar;
  private JMenu fileMenu, robotMenu;
  private JMenuItem restartMI, loadMI, quitMI, randomRobotMI, leftHandRobotMI, recursionRobotMI, memoryRobotMI, currentRobotMI;
  ...
  //<editor-fold defaultstate="collapsed" desc="--Lab1001 Constructor--">
  public Lab1001(int w, int h, JFrame f)
  {
    ...
    memoryRobotMI = new JRadioButtonMenuItem("Memory Robot ");
    memoryRobotMI.setFont(vb12);
    memoryRobotMI.addActionListener(this);
    robotGroup.add(memoryRobotMI);
    robotMenu.add(memoryRobotMI);
    ...
    speed = new JSlider(SwingConstants.HORIZONTAL, 0, 100, 50);
    menuBar.add(speed);
    speed.addChangeListener(this);
    speed.setMinorTickSpacing(10);
    speed.setPaintTicks(true);
    Dimension width = new Dimension(200, 25);
    speed.setPreferredSize(width);
    speed.setMinimumSize(width);
    speed.setMaximumSize(width);
  ...
  private void start()
  {
    ...
    //else if (currentRobotMI == memoryRobotMI) robbie = new MemoryRobot(m);
