...
/*
 * File Name: Lab1000.java
 *   Created: Feb 20, 2014
 *    Author: David Rogers
 */


public class Lab1000 extends JPanel
{
  ...
  // Constructor
  public Lab1000(int w, int h, JFrame f)
  {
  ...
  public static void main(String[] args)
  {
    ...
    JFrame fr = new JFrame("Application: Lab1000");
    fr.setContentPane(new Lab1000(800, 600, fr));
