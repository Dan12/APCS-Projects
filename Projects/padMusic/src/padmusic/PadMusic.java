...
public class PadMusic extends JFXPanel implements KeyListener, MouseListener
{
  ...
  String source1[] = {"","","","","","","","","",""};
  String source2[] = {"BoomBoomLoop.mp3","Mixed Beat 140.wav","Whoop Whoop A# 140 1.wav","","","","","","",""};
  String source3[] = {"Emax Hit 01.wav","PLP-Electrofied_Bass10.wav","PLP_Tenori-On Beat 07.wav","PLP_Tenori-On Synth 04.wav","","","","","",""};
  String source4[] = {"LC_Complextro_Synth_128_F.wav","LC_Deep_Indie_Bass_128_C_sidechained.wav","LC_Drum_Top_128_2.wav","LC_mau5pad_128_A#_4.wav","","","","","",""};
  ...
  public PadMusic(int w, int h, JFrame f)
  {
    ...
    d.setBounds(300, 10, 180, 40);
    d.setVisible(false);
    super.add(d);
    d.setFocusable(false);
    d.setFont(new Font("TimesRoman", Font.PLAIN, 14));
    addKeyListener(this);
